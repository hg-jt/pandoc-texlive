...
PLEX_SANS_CONDENSED_VERSION=1.1.0
...
curl -L -O https://github.com/IBM/plex/releases/download/@ibm/plex-sans-condensed@$PLEX_SANS_CONDENSED_VERSION/ibm-plex-sans-condensed.zip
unzip ibm-plex-sans-condensed.zip
mv ibm-plex-sans-condensed/fonts/complete/otf /usr/share/fonts/opentype/ibmplexsanscondensed
